...
urlpatterns = [
    ...
    path('trainers/base/<str:id>/', views.TrainerBaseInfo.as_view()),
    ...
    path('create_trainer/<str:id>/', csrf_exempt(views.CreateTrainer.as_view())),
    path('create_trainer/', csrf_exempt(views.CreateTrainer.as_view())),
    path('modificate_trainer/<str:id>/', csrf_exempt(views.Modificate_Trainer.as_view())),
]
